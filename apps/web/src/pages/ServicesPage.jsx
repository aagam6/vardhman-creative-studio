...
import { Film, Sparkles, Palette, ArrowRight, Settings } from 'lucide-react';
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <p className="text-gray-400 font-light leading-relaxed text-sm sm:text-base mb-6">
                        {service.description}
                      </p>
                      
                      <Link
                        to={`/?service=${service.id}#contact`}
                        className="inline-flex items-center gap-1.5 rounded-full bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs uppercase tracking-wider px-5 py-3 transition-all duration-300"
                      >
                        Inquire for this Service <ArrowRight className="h-3.5 w-3.5" />
                      </Link>
                    </div>
